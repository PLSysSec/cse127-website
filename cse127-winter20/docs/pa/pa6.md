...
**Deadline Friday, March 13, 2020 by 23:59:59**

**Early Turn-In: Wednesday, March 11, 2020 by 23:59:59**
...
```python
h = md5(state=codecs.decode("3ecc68efa1871751ea9b0b1a5b25004d", "hex"), count=512)
```
